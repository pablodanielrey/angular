...
class Art102JustificationDAO(DAO):
    ...
    def _fromResult(cls, con, r):
        c = Art102Justification(r['user_id'], r['owner_id'], r['date'])
        c.id = r['id']
    ...
    def persist(cls, con, c):
        ...
        try:
            if ((not hasattr(c, 'id')) or (c.id is None)):
                ...
                r = c.__dict__
                cur.execute('insert into assistance.justification_art102 (id, user_id, owner_id, date) '
    ...
    def findByUserId(cls, con, userIds, start, end):
        ...
        try:
            ...
            cur.execute('select * from assistance.justification_art102 where user_id  in %s and date BETWEEN %s AND %s', (tupe(userIds), sDate, eDate))
            return [ cls._fromResult(con, r) for r in cur ]
        finally:
            cur.close()
