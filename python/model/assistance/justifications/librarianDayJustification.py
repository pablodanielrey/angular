...
class LibrarianDayJustificationDAO(AssistanceDAO):
    ...
    def _createSchema(cls, con):
        ...
        try:
            sql = """
              ...
              create table IF NOT EXISTS assistance.justification_librarian_day (
    ...
    def findById(cls, con, ids):
        ...
        cur = con.cursor()
        try:
            cur.execute('select * from assistance.justification_librarian_day where id in %s', (tuple(ids),))
    ...
    def findByUserId(cls, con, userIds, start, end):
        ...
        try:
            ...
            cur.execute('select * from assistance.justification_librarian_day where user_id  in %s and date BETWEEN %s AND %s', (tupe(userIds), sDate, eDate))
            return [ cls._fromResult(con, r) for r in cur ]
        finally:
            cur.close()
