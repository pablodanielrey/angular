# -*- coding: utf-8 -*-
'''
    implementa la justificación de Junta Médica
...
class MedicalBoardJustificationDAO(AssistanceDAO):
    ...
    def _createSchema(cls, con):
        ...
        try:
            sql = """
              ...
              create table IF NOT EXISTS assistance.justification_medical_board (
