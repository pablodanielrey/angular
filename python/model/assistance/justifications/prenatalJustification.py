...
class PrenatalJustificationDAO:
    ...
    def _createSchema(con):
        ...
        try:
            cur.execute("""
                ...
                create table assistance.justification_prenatal (
            ...
            """.format(PrenatalJustificationDAO.TABLE_NAME))
        finally:
            cur.close()
    ...
    def findById(con, ids):
        ...
        try:
            ...
            return [ PrenatalJustificationDAO._fromResult(con, r) for r in cur ]
        finally:
            cur.close()
