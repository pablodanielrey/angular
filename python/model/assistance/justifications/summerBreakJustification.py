...
class SummerBreakJustificationDAO(AssistanceDAO):
    ...
    def persist(cls, con, j):
        ...
        try:
            ...
            if len(j.findById(con, [j.id])) <=  0:
                r = j.__dict__
                cur.execute('insert into assistance.justification_summer_break (id, user_id, owner_id, jstart, jend, notes) '
