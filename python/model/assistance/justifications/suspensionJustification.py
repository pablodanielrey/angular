# -*- coding: utf-8 -*-
'''
    implementa la justificación de Suspensión
...
class SuspensionJustificationDAO(DAO):
    ...
    def _createSchema(cls, con):
        ...
        try:
            sql = """
              ...
              create table IF NOT EXISTS assistance.justification_suspension (
    ...
    def findById(cls, con, ids):
        ...
        try:
            ...
            cur.execute('select * from assistance.justification_suspension where id in %s',(tuple(ids),))
            return [ SuspensionJustificationDAO._fromResult(con, r) for r in cur ]
        finally:
            cur.close()
...
class SuspensionJustification(RangedJustification):
