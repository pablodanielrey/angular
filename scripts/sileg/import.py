...
if __name__ == '__main__':
    ...
    try:
        conD = dcsysConn.get()
        try:
            logging.info('importando las designaciones de catedras')
            ImportSileg.importDesignacionFromCatedra(conS, conD)

            logging.info('importando las designaciones de lugar de trabajo')
            ImportSileg.importDesignacionFromLugarTrabajo(conS, conD)

            logging.info('importando las extensiones de catedras')
            ImportSileg.importDesignacionFromExtensionCatedra(conS, conD)

            logging.info('importando las extensiones de lugar de trabajo')
            ImportSileg.importDesignacionFromExtensionLugarTrabajo(conS, conD)

            logging.info('importando las extensiones de designaciones de catedras')
