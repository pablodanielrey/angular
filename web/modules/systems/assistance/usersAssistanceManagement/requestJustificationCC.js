...
app.controller('UsersAssistanceManagementRequestJustificationCCCtrl', ["$scope", "Assistance", "Notifications", "Utils", function($scope, Assistance, Notifications, Utils) {
  ...
  $scope.rjModel = {
    ...
    name: Utils.getJustificationName('508a9b3a-e326-4b77-a103-3399cb65f82a'),
    section: null,
