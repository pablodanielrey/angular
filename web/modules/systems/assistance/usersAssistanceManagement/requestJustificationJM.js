...
app.controller('UsersAssistanceManagementRequestJustificationJMCtrl', ["$scope", "Assistance", "Notifications", "Utils", function($scope, Assistance, Notifications, Utils) {
  ...
  $scope.rjModel = {
    ...
    name: Utils.getJustificationName('478a2e35-51b8-427a-986e-591a9ee449d8'),
    section: null,
