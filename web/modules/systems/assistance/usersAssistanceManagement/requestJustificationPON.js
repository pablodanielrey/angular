...
app.controller('UsersAssistanceManagementRequestJustificationPONCtrl', ["$scope", "Assistance", "Notifications", "Utils", function($scope, Assistance, Notifications, Utils) {
  ...
  $scope.rjModel = {
    ...
    name: Utils.getJustificationName('68bf4c98-984d-4b71-98b0-4165c69d62ce'),
    section: null,
