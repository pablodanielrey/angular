...
app.controller('UsersAssistanceManagementRequestJustificationSGSCtrl', ["$scope", "Assistance", "Notifications", "Utils", function($scope, Assistance, Notifications, Utils) {
  ...
  $scope.rjModel = {
    ...
    name: Utils.getJustificationName('1c14a13c-2358-424f-89d3-d639a9404579'),
    section: null,
