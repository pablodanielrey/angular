...
app.controller('UsersAssistanceManagementRequestJustificationSUSCtrl', ["$scope", "Assistance", "Notifications", "Utils", function($scope, Assistance, Notifications, Utils) {
  ...
  $scope.rjModel = {
    ...
    name: Utils.getJustificationName('bfaebb07-8d08-4551-b264-85eb4cab6ef1'),
    section: null,
