...
app.controller('UsersAssistanceManagementMediatorRequestJustificationAACtrl', ["$scope", "Assistance", "Notifications", "Utils", function($scope, Assistance, Notifications, Utils) {
  ...
  $scope.rjModel = {
    ...
    name: Utils.getJustificationName('e0dfcef6-98bb-4624-ae6c-960657a9a741'),
    section: null,
