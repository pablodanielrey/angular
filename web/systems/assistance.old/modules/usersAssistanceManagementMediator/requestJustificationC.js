...
app.controller('UsersAssistanceManagementMediatorRequestJustificationCCtrl', ["$scope", "Assistance", "Notifications", "Utils", function($scope, Assistance, Notifications, Utils) {
  ...
  $scope.rjModel = {
    ...
    name: Utils.getJustificationName('48773fd7-8502-4079-8ad5-963618abe725'),
    section: null,
