 ...
 */
app.controller('RequestAuthorityCtrl', ["$scope", "$timeout", "$window", "Assistance", "Office", "Notifications", "Users", "Session", "Utils", function($scope, $timeout, $window, Assistance, Office, Notifications, Users, Session, Utils) {
  ...
  $scope.persistOvertime = function(){
    ...
    var userId = $scope.model.user_id;
    var reason = $scope.model.reason;
    Assistance.requestOvertime(requestorId, userId, begin, end, reason,
