...
app.controller('UsersAssistanceManagementRequestJustificationCONCtrl', ["$scope", "Assistance", "Notifications", "Utils", function($scope, Assistance, Notifications, Utils) {
  ...
  $scope.rjModel = {
    ...
    name: Utils.getJustificationName('5289eac5-9221-4a09-932c-9f1e3d099a47'),
    section: null,
