...
app.controller('ShowAssistanceCtrl', ["$scope", "$timeout", "$window", "Notifications" , "Session", "Assistance", "Office", "Users", "Utils","$filter", function($scope, $timeout, $window, Notifications, Session, Assistance, Office, Users, Utils,$filter) {
...
// ----------- INICIALIZACION --------------------
  ...
  */
  ...
  $scope.filterUsers = function() {
    ...
    Office.getOfficesUsers(offices,
      function(users) {
        for (var $i = 0; $i < users.length; $i++) {
          var uid = users[$i];
