 ...
 */
app.controller('SearchPubCtrl', ["$rootScope", "$location", "$timeout", "$window", "Notifications", "Session", "WebSocket", function ($rootScope, $location, $timeout, $window, Notifications, Session, WebSocket) {
